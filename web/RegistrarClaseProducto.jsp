...
<html>
    <head>
        ...
        <script type="text/javascript" src="js/RegistrarCP2.js"></script>
        <title>Nueva Clase Producto</title>
    </head>
            ...
            <div  class="container container-sm border p-3 mb-2" style="background-color: #ECF0F1;">
                ...
                <div class="row justify-content-center">
                    <div class="col-sm-8" style="padding-top: 2%; background-color: #34495E; border: solid #17202A;">
                        ...
                        <div class="row justify-content-center">
                            <h2 style="color: #F1C40F;">Nueva Clase de Producto</h2>
                        </div>
                        <hr style="border-top: 2px solid #FDFEFE;">

                        <!--formulario-->
                        <form id="frmRegistrarCP" name="frm" action="Servlet_CP" method="post" >
                            ...
                            <div class="form-group row justify-content-center">
                                ...
                                <div style="padding-right: 1%;">
                                    ...
                                    <input name="txtCodigo" type="text" value="<%=Codigo_CP%>" class="btn btn-light btn-sm" readonly="readonly" style="width: 6em;">  
                            ...
                            <div class="form-group row justify-content-center">
                                ...
                                <div >
                                    ...
                                    type="text" class="form-control form-control-sm" minlength="10"maxlength="30" placeholder="Ingrese el nuevo tipo de producto"
                                    style="width: 16em;">
                                </div>
                            </div>                            
